...
public sealed class DeathHandlerModifier : BaseModifier
{
    ...
    public static void UpdateDeathHandler(PlayerControl player, Color color, DeathReasonShow causeOfDeath = DeathReasonShow.None, DeathHandlerOverride diedThisRound = DeathHandlerOverride.Ignore, string killedBy = "null", DeathHandlerOverride lockInfo = DeathHandlerOverride.Ignore)
    {
        ...
        Coroutines.Start(CoWriteDeathHandler(player, causeOfDeath, diedThisRound, killedBy, lockInfo, color));
    }
