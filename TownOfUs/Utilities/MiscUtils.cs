...
public static class MiscUtils
{
    ...
    public static void ShowNotification(string text, Color color = new(), Sprite? sprite = null, float thickness = 0.35f)
    {
    ...
    public static Alignment GetRoleAlignment(this RoleBehaviour role)
    {
